...
@section('content')
    ...
    <div class="relative min-h-screen bg-gray-100 bg-center sm:flex sm:justify-center sm:items-center bg-dots dark:bg-gray-900 selection:bg-indigo-500 selection:text-white">
        ...
        <div class="p-6 mx-auto max-w-7xl lg:p-8">
            <h1 class="text-6xl font-bold font-sans text-slate-600">vm-observe</h1>
            <h2 class="text-gray-400 pt-2">An open source project - part of an assessment</h2>
            <p class="text-gray-500 italic pt-2">
